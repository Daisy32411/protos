...
type AuthClient interface {
	...
	IsAdmin(ctx context.Context, in *IsAdminRequset, opts ...grpc.CallOption) (*IsAdminResponse, error)
}
...
func (c *authClient) IsAdmin(ctx context.Context, in *IsAdminRequset, opts ...grpc.CallOption) (*IsAdminResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	IsAdmin(context.Context, *IsAdminRequset) (*IsAdminResponse, error)
...
func (UnimplementedAuthServer) IsAdmin(context.Context, *IsAdminRequset) (*IsAdminResponse, error) {
...
func _Auth_IsAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).IsAdmin(ctx, req.(*IsAdminRequset))
	}
	return interceptor(ctx, in, info, handler)
}
